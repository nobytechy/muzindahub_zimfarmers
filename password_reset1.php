...
<title>Password Retriever</title>
</head>
<body>
<?php
...
<center> <form action=""  method="post" style="width: 50%" autocomplete="off">
	<h3 class="text-center">Agric.Helper password recovery</h3>
 ...
 class="glyphicon glyphicon-lock"></span> <u><?php echo strrev($pass); ?></u> </p>
        ...
        <button type="submit" name="pass_retrive1"  style="margin-top:3px;margin-bottom:3px" class="btn btn-lg btn-success">Retrieve</button>
</form></center>
